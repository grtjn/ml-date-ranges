# Contributing to ml-date-ranges

ml-date-ranges welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use ml-date-ranges, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][mlstack] to see if it has been answered there, and post your question there if not. Please tag it with MarkLogic.
...
* **ml-date-ranges Version** - is it a named version or from our master branch
...
Fork the project [on GitHub](https://github.com/grtjn/ml-date-ranges/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/ml-date-ranges.git
$ cd ml-date-ranges
$ git remote add upstream git://github.com/grtjn/ml-date-ranges.git
```
...
Go to https://github.com/username/ml-date-ranges and select your feature branch. Click
...
[wiki]: https://github.com/grtjn/ml-date-ranges/wiki
[mlstack]: http://stackoverflow.com/questions/tagged/marklogic
[issue tracker]: https://github.com/grtjn/ml-date-ranges/issues
